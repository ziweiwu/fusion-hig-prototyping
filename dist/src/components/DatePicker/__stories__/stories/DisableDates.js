...
var DisableDates = function (_Component) {
  _inherits(DisableDates, _Component);

  function DisableDates(props) {
    _classCallCheck(this, DisableDates);

    var _this = _possibleConstructorReturn(this, (DisableDates.__proto__ || Object.getPrototypeOf(DisableDates)).call(this, props));
  ...
  _createClass(DisableDates, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(_index2.default, {
        ...
        maxDate: (0, _moment2.default)().add(maxDate, 'days'),
...
exports.default = DisableDates;

//# sourceMappingURL=DisableDates.js.map